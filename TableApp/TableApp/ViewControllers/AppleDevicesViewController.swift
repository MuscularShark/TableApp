...
//        
////        cell.commonInit(devices[indexPath.section].allDevices[indexPath.row].im, title: devices[indexPath.section].allDevices[indexPath.row].rawValue, info: devices[indexPath.section].allDevices[indexPath.row].rawValue)
//        return cell
//        
//    }
//    
